...
export default function BlogCard({ blog }) {
  return (
    <motion.div
      ...
      className="bg-[#1a1a1a] text-white rounded-2xl shadow-lg border border-[#333] p-4 flex flex-col justify-between min-h-[400px] transition-all hover:shadow-[0_0_20px_#c5ff4a55]"
    >
      {/* Header */}
      ...
      <div className="mt-4 flex justify-between text-[#aaa] text-sm">
        ...
        <div className="flex gap-4 text-base">
          ...
          <MessageCircle
            ...
            size={16}
          />
          <Bookmark className="cursor-pointer hover:text-[#c5ff4a]" size={16} />
